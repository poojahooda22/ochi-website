...
const Navbar = forwardRef(function index(props, ref) {
  ...
  return (
    <div className={`${styles.header} w-full px-12 py-8 font-['Neue Montreal'] fixed z-[999]`}>
      <div className="logo">
      ...
      <div className="links flex gap-6 items-center">
        {["Services", "Our work", "About us", "Insights"].map((item, index) => (
          <h4 key={index} className={`${styles.heading4} relative font-medium text-sm  md:px-[20px] 
          md:py-[8px] border-[1px] border-[#333] rounded-[50px] overflow-hidden`}
          >
