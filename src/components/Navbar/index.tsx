...
const Navbar = forwardRef(function index(props, ref) {
  ...
  return (
    <div className={`${styles.header} w-full px-8 py-1 font-['Neue Montreal'] fixed bg-gradient-to-b from-white to-transparent`}>
      <div className="logo ">
        <svg width="52" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
